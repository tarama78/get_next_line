...
nnoremap v :so $MYVIMRC
nnoremap f fL
nnoremap ma :set mouse=a
nnoremap mm :set mouse=
nnoremap ; :% s/)\n/);\r/g
nnoremap  :wa:wqa
nnoremap q :wa:wqa
nnoremap  :wa
nnoremap w :wa
nnoremap <F5> :wa:mksession!:wqa
nnoremap  :execute "tabnew ".g:help_vim_file
nnoremap h :execute "tabnew ".g:help_vim_file
nnoremap c :!cat %
nnoremap b :ConqueTerm bash<Up><Down>
nnoremap z :ConqueTerm zsh<Up><Down>
...
inoremap 	 :tabmove +1
inoremap V :so $MYVIMRC
inoremap  :so $MYVIMRC
inoremap v :so $MYVIMRC
inoremap f fLi
inoremap ma :set mouse=aa
inoremap mm :set mouse=a
inoremap ; :% s/)\n/);\r/g
inoremap  :wa:wqa
inoremap q :wa:wqa
inoremap  :wa
inoremap w :wa
inoremap <F5> :wa:mksession!:wqa
inoremap  :execute "tabnew ".g:help_vim_file
inoremap h :execute "tabnew ".g:help_vim_file
inoremap c <exc>:!cat %
inoremap b :ConqueTerm bash<Up><Down>
inoremap z :ConqueTerm zsh<Up><Down>
inoremap  :NERDTreeClose=
inoremap g :NERDTree=
cnoremap WW !clear && echo "-----------------------------------------------------------------------------"&& norminette % &&echo "-----------------------------------------------------------------------------"
cnoremap Ww !clear && echo "-----------------------------------------------------------------------------"&& norminette % &&echo "-----------------------------------------------------------------------------"
cnoremap WqA wqa
cnoremap Wqa wqa
cnoremap WQa wqa
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 58 - ((36 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
58
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 97 - ((42 * winheight(0) + 39) / 78)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
97
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 39 - ((20 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
